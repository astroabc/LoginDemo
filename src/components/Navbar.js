...
export default function Navbar() {
  return (
        <div className='w-[1100px] m-auto'>
          <div className='h-12 bg-white flex flex-row items-center justify-center pt-3'>
            <div className='flex flex-row items-center w-[800px]'>
            ...
            <ul className='flex flex-row items-center justify-between flex-wrap w-[300px] gap-2'>
              <li>Trang chủ</li>
              <li>Astra</li>
              <li>Tui</li>
              <li>Giỏ hàng</li>
